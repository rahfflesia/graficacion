...
export type rolesOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"idrol" | "idproyecto" | "tipo" | "nombre", ExtArgs["result"]["roles"]>
...
export interface rolesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const rolesWithIdrolOnly = await prisma.roles.findMany({ select: { idrol: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Roles and only return the `idrol`
   * const rolesWithIdrolOnly = await prisma.roles.createManyAndReturn({
   *   select: { idrol: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Roles and only return the `idrol`
   * const rolesWithIdrolOnly = await prisma.roles.updateManyAndReturn({
   *   select: { idrol: true },
   *   where: {
   *     // ... provide filter here
   *   },
