...
/**
  ...
  /**
   * `prisma.stakeholders`: Exposes CRUD operations for the **stakeholders** model.
    * Example usage:
    * ```ts
    ...
    * ```
    */
  get stakeholders(): Prisma.stakeholdersDelegate<ExtArgs, { omit: OmitOpts }>;
}
